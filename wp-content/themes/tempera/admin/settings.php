...
function cryout_setting_mobile_fn() {
	...
	echo "</select></span>";
	$checkedClass = ($temperas['tempera_hcontain']=='1') ? ' checkedClass' : '';
...
function cryout_setting_frontposts_fn() {
	...
	echo "<input type='text' id='tempera_frontpostscount' name='tempera_settings[tempera_frontpostscount]' size='3' value='";
 	...
 	echo "<div><small>".__("Enable to display latest posts on the presentation page, below the columns. Sticky posts are always displayed and not counted.","tempera")."</small></div>";
} // cryout_setting_frontpage_fn()
...
function cryout_setting_frontslider2_fn() {
	...
	$itemsare = array( __("Custom Slides","tempera"), __("Latest Posts","tempera"), __("Random Posts","tempera"),__("Sticky Posts","tempera"), __("Latest Posts from Category","tempera"), __("Random Posts from Category","tempera"), __("Specific Posts","tempera"));
...
function cryout_setting_frontcolumns_fn() {
	...
	$itemsare = array( __("Widget Columns","tempera"), __("Latest Posts","tempera"), __("Random Posts","tempera"),__("Sticky Posts","tempera"), __("Latest Posts from Category","tempera"), __("Random Posts from Category","tempera"), __("Specific Posts","tempera"));
...
<?php	echo "<div class='slmini'><b>".__("Columns per row:","tempera")."</b> ";
	$items = array ("1", "2" , "3" , "4");
...
/*
//CHECKBOX - Name: tempera_settings[postdate]
function cryout_setting_postcomlink_fn() {
	global $temperas;
	$items = array ("Show" , "Hide");
	$itemsare = array( __("Show","tempera"), __("Hide","tempera"));
	echo "<select id='tempera_postcomlink' name='tempera_settings[tempera_postcomlink]'>";
foreach($items as $id=>$item) {
	echo "<option value='$item'";
	selected($temperas['tempera_postcomlink'],$item);
	echo ">$itemsare[$id]</option>";
}
	echo "</select>";
	echo "<div><small>".__("Hide or show the <strong>Leave a comment</strong> or <strong>x Comments</strong> next to posts or post excerpts.","tempera")."</small></div>";
}

function cryout_setting_postdatetime_fn() {
	global $temperas;
	$items = array ("datetime", "date", "time", "hide");
	$itemsare = array( __("Date and time","tempera"), __("Date only","tempera"), __("Time only","tempera"), __("Hide both","tempera"));
	echo "<select id='tempera_postdatetime' name='tempera_settings[tempera_postdatetime]'>";
foreach($items as $id=>$item) {
	echo "<option value='$item'";
	selected($temperas['tempera_postdatetime'],$item);
	echo ">$itemsare[$id]</option>";
}
	echo "</select>";
	echo "<div><small>".__("Hide or show the post date and time.","tempera")."</small></div>";
}

//CHECKBOX - Name: tempera_settings[postauthor]
function cryout_setting_postauthor_fn() {
	global $temperas;
	$items = array ("Show" , "Hide");
	$itemsare = array( __("Show","tempera"), __("Hide","tempera"));
	echo "<select id='tempera_postauthor' name='tempera_settings[tempera_postauthor]'>";
foreach($items as $id=>$item) {
	echo "<option value='$item'";
	selected($temperas['tempera_postauthor'],$item);
	echo ">$itemsare[$id]</option>";
}
	echo "</select>";
	echo "<div><small>".__("Hide or show the post author.","tempera")."</small></div>";
}

//CHECKBOX - Name: tempera_settings[postcateg]
function cryout_setting_postcateg_fn() {
	global $temperas;
	$items = array ("Show" , "Hide");
	$itemsare = array( __("Show","tempera"), __("Hide","tempera"));
	echo "<select id='tempera_postcateg' name='tempera_settings[tempera_postcateg]'>";
foreach($items as $id=>$item) {
	echo "<option value='$item'";
	selected($temperas['tempera_postcateg'],$item);
	echo ">$itemsare[$id]</option>";
}
	echo "</select>";
	echo "<div><small>".__("Hide the post category.","tempera")."</small></div>";
}

//CHECKBOX - Name: tempera_settings[posttag]
function cryout_setting_posttag_fn() {
	global $temperas;
	$items = array ("Show" , "Hide");
	$itemsare = array( __("Show","tempera"), __("Hide","tempera"));
	echo "<select id='tempera_posttag' name='tempera_settings[tempera_posttag]'>";
foreach($items as $id=>$item) {
	echo "<option value='$item'";
	selected($temperas['tempera_posttag'],$item);
	echo ">$itemsare[$id]</option>";
}
	echo "</select>";
	echo "<div><small>".__("Hide the post tags.","tempera")."</small></div>";
}

//CHECKBOX - Name: tempera_settings[postbook]
function cryout_setting_postbook_fn() {
	global $temperas;
	$items = array ("Show" , "Hide");
	$itemsare = array( __("Show","tempera"), __("Hide","tempera"));
	echo "<select id='tempera_postbook' name='tempera_settings[tempera_postbook]'>";
foreach($items as $id=>$item) {
	echo "<option value='$item'";
	selected($temperas['tempera_postbook'],$item);
	echo ">$itemsare[$id]</option>";
}
	echo "</select>";
	echo "<div><small>".__("Hide the 'Bookmark permalink'.","tempera")."</small></div>";
}
